...
?>  
  ...
  <div class="row">
   ...
   <p class="plan-subheading">You have successfully registered with RedCarpetMatrimony</p>
     </div>
  </section> 
              ...
              <div class="tab-content plans-box">
                <div id="Online" class="tab-pane fade in active  gallery">                  
                  ...
                  <div class="row row-padded plan-features row-bordered p-t text-center">
				    <p class="plan-tagline"> Your Login Details on RedCarpetMatrimony </p>
                   <h3>Your Matrimony ID: RCM2037452</h3>
				   
				   
				   <p>Henceforth please use the above matrimony ID to login to your profile at RedCarpetMatrimony.com. A confirmation mail has been sent to your e-mail on how to use the site efficiently in finding your match</p>
