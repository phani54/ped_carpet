...
<html lang=''>
	...
	<body>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-3">
						...
						<div class="box-br">
							...
							<div class="col-sm-12 no-padd">
								<br><a href=""><b>Wedding Collection</b></a><br>
								<small>3 Items</small>
								<small class="pull-right">November 4, 2015</small>
							</div>
							<div class="clearfix"></div>
						</div>
						</a>
					...
					<div class="col-sm-3">
						...
						<div class="box-br">
							...
							<div class="col-xs-12 no-padd">
								<br><a href=""><b>Summer Collection</b></a><br>
								<small>3 Items</small>
								<small class="pull-right">November 1, 2015</small>
							</div>
							<div class="clearfix"></div>
						</div>
						</a>
					...
					<div class="col-sm-3" align="center">
						<div class="">
							<div class="col-sm-12 no-padd">
								<h3>Let's Get Dressed!</h3>
							</div>
							<div class="col-sm-12 no-padd">
								<br>Create a wishlist for each of your upcoming events. Get started here!<br><br>
								<a href="" class="btn btn-success col-sm-12">Cleate Your's Wishlist</a><br><br>
								<a href="" class="btn btn-success col-sm-12">Browse Outfits</a>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
		...
		<div class="clearfix"></div><br><br><br><br><br><br><br><br><br>
