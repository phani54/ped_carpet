      ...
      <div class="col-sm-7">
        <div id="ResultArea" class="Tabbox tabContainer active" style="padding-top: 0;">
            <?php 
                ...
                {
                    // looking_for=female&age_from=20&age_to=28&religion=&search=profile_search
                    if(isset($_GET['looking_for']) && $_GET['looking_for']!='')
                    {
                        $condition.= " AND gender='".$_GET['looking_for']."'";
                        $other_params.= 'looking_for='.$_GET['looking_for'].'&';
                    }
                    else
                    {
                        $other_params.= 'looking_for=&';
                    }
                    if(isset($_GET['religion']) &&  $_GET['religion']!='')
                    {
                        $condition.= " AND religion='".$_GET['religion']."'";
                        $other_params.= 'religion='.$_GET['religion'].'&';
                    }
                    else
                    {
                        $other_params.= 'religion=&';
                    }
