 ...
 * @version: 0.9.0
 */
define('NICUPLOAD_PATH','/home/catchwa1/public_html/hydmodels/Innovatech.in/cw_admin/upload/'); // Set the path (relative or absolute) to
                                      // the directory to save image files
define('NICUPLOAD_URI', 'http://www.catchway.biz/hydmodels/Innovatech.in/cw_admin/upload/');   // Set the URL (relative or absolute) to
